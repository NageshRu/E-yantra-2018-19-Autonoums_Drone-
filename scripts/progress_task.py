...
class DroneFly():
	...
	def __init__(self):
		...
		self.waypoints=[(-5.10,-0.54,21.70),(0,0,17)]
	...
	* Example Call: self.disarm()
	...
	def drone_start_loc(self):
		...
		print "starting lcation: ",self.wp_x,self.wp_y,self.wp_z 
